...
<script src="/static/admin/material.js"></script>
<body class="hold-transition skin-blue sidebar-mini">
<div class="wrapper">
{{template "public/menu.tpl" .}}
    <script type="text/javascript">
        activeDiv=function () {
            $('#mat-li').addClass("active");
        };
    </script>
                        ...
                        <div class="box-body">
                            <div class="form-inline" style="height:28px">
                                <div style="float:left">
                                    <button id="addBtn" class="btn btn-primary btn"><span class="glyphicon glyphicon-plus"></span>&nbsp上传课程资料</button>
                                </div>
                            </div>
                            ...
                            <div id="matTable" style="margin:10px 0"></div>
                        </div>
    ...
    <div id="matModal" class="modal fade" data-backdrop="static">
                ...
                <div class="box">
                    ...
                    <div class="modal-body" style="text-align:center;">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="brief" class="col-sm-3 control-label">简介</label>
                                    <div class="col-sm-6">
